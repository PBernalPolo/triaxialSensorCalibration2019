...
public class InformationSource {
  ...
  private long tLastMeasurement;  // time at which the last measurement arrived
  ...
  public InformationSource() {
    this.tLastMeasurement = System.nanoTime();
  ...
  public void update_measurement( byte[] theMeasurement ) {
    ...
    this.averageMeasurementPeriod = (1.0-InformationSource.alpha)*this.averageMeasurementPeriod + InformationSource.alpha*((t-this.tLastMeasurement)*1.0e-9);
  ...
  public double get_tLastMeasurement() {
